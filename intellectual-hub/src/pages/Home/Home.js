...
const Home = ({ category, setCategory, name, setName, email, setEmail, setPassword, password, fetchQuestions, location }) => {
        ...
        <Container>
            <div className="main-div">
                ...
                <div className="subheader">
                    <h3 className="subtitle">Choose one from the categories below and see how many questions you can answer correctly out of 10 questions!
                    </h3>
                </div>
                    ...
                    <div className="circular-figure__category-name">
                        <div className="music__circle" >
                            <span onClick={selectedCategoryFilm}>
                                ...
                                <img className="images" src="http://devinardya-quizmaster.surge.sh/static/media/movie-icon.719897dc.svg" />
                            </span>
                        </div>
                    ...
                    <div className="circular-figure__category-name">
                        <div className="music__circle">
                            <span onClick={selectedCategoryMusic}>
                                <img className="images" src="http://devinardya-quizmaster.surge.sh/static/media/music-icon.469e959f.svg" />
                            </span>
                        </div>
                    ...
                    <div className="circular-figure__category-name">
                        <div className="music__circle">
                            <span onClick={selectedCategoryComputer}>
                                ...
                                <img className="images" src="http://devinardya-quizmaster.surge.sh/static/media/books-icon.3b876aa2.svg" />
                            </span>
                        </div>
